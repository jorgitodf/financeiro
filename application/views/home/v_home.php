...
<div class="container-fluid col-md-sm col-md-12 col-lg-12 div_page_principal">
    <div class="row-fluid">
        <?php if (!empty($conta)): ?>
        <section class="jumbotron col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3" id="sec_sem_conta">
            <p><?php echo $conta; ?></p>
            <a class="btn btn-primary" href="/conta" role="button">Cadastrar Conta</a>
        </section>
        <?php else: ?>
          <section class="jumbotron col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3" id="sec_com_conta">
