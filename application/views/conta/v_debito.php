...
<div class="container-fluid col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="row-fluid">
        <section class="col-xs-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3 jumbotron" id="sec_debito">
            <form method="POST" action="/conta/debitar" id="form_cad_debito">
                <div class="panel panel-primary" id="div_panel_form_debitar">
                    ...
                    <div class="panel-body">
                        <div class="row-fluid">
                            <div class="form-group form-group-sm col-xs-12 col-sm-5 col-md-5" id="">
                            ...
                            <div class="form-group form-group-sm col-xs-12 col-sm-7 col-md-7" id="">
                        ...
                        <div class="row-fluid">
                            <div class="form-group form-group-sm col-xs-12 col-sm-6 col-md-6" id="">
                        ...
                        <div class="row-fluid">
                            <div class="form-group form-group-sm col-xs-12 col-sm-5 col-md-5">
                                <button type="button" id="btn_novo_debito" class="btn btn-primary btn_tam_dev">Novo</button>
                                <button type="submit" id="btn_salvar_debito" class="btn btn-primary btn_tam_dev" disabled="disabled">Debitar</button>
                                <a class="btn btn-primary btn_tam_dev" href="/conta/acessar/<?php echo $idConta; ?>">Início</a>
                            </div>
                            <div class="form-group form-group-sm retorno col-xs-12 col-sm-7 col-md-7" id="retorno_debito">
                            </div>
                        </div>
                    </div>
                </div>
