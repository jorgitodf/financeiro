...
<div class="container-fluid col-sm-12 col-md-12 col-lg-12">
    <div class="row-fluid">
        <section class="col-md-12 col-lg-12 col-sm-12 jumbotron" id="sec_listar_pagamento_agendado">
                ...
                <div class="panel panel-success">
                            ...
                            <tbody>
                                <?php foreach ($pgto_agendados as $value): ?>
                                    <tr>
                                        ...
                                        <td><?php echo ucwords($value['mov']); ?></td>
                    ...
                    <div class="row-fluid" id="div_nav_pagination">
                        <nav aria-label="Page navigation" id="nav_pagination">
                            <ul class="pagination">
                                <li><a href="/agendamento/listar?p=0" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                                </li>
                                <?php for ($q = 1; $q <= $p_count; $q++) { 
                                //$estilo = ""; if ($p_count == $q) { $estilo = "class =\"active\""; <?php echo $estilo; } ?>
                                    <li ><a href="/agendamento/listar?p=<?php echo $q; ?>"><?php echo $q; ?></a></li>
                                <?php } ?>	
                                <li><a href="/agendamento/listar?p=<?php echo $p_count; ?>" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
                                </li>
                            </ul>
                        </nav>
                    </div>    
